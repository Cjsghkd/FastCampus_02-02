...
import com.example.moviereviewapp.databinding.ItemFeaturedMovieBinding
import com.example.moviereviewapp.databinding.ItemMovieBinding
...
class HomeAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class FeaturedMovieItemViewHolder(private val binding: ItemFeaturedMovieBinding): RecyclerView.ViewHolder(binding.root) {
        init {
